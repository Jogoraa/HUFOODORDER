...
class FirebaseAuthHelper {
  ...
  Future<bool> signUp(
    ...
    try {
      ...
      String idCardUrl =
          await FirebaseStorageHelper.instance.uploadEmployeeIdCard(
        reference.id,
        idCard,
      );

      String profileUrl =
          await FirebaseStorageHelper.instance.uploadEmployeeProfile(
        reference.id,
        profile,
      );

      if (profileUrl == null) {
        // Handle the case where file uploads fail
      ...
      Navigator.of(context).pop(); // Remove the loader dialog
      return true;
