                      ...
                      return DataRow(
                        ...
                        cells: [
                          DataCell(
                            CupertinoButton(
                              onPressed: () {
                                showDetailsDialog(context, order);
                              },
                              child: SizedBox(
                                height: 30,
                                width: 30,
            ...
            child: Column(
              ...
              children: [
                ...
                text(
                    ...
                    title: 'Product Name :  ${order.products[0].name}'),
                text(
                    color: Colors.grey.shade700,
                    title:
                        'Total quantity  :  ${order.products[0].quantity.toString()}'),
                text(
                    color: Colors.grey.shade700,
                    title:
                        'Total Price  :  ${order.products[0].price.toString()}'),
              ],
            ),
          ),
          actions: [
  ...
  Future<void> updateDeliveryOrder(OrderModel orderModel, String status) async {
    ...
    try {
      ...
      if (sellerSnapshot.exists) {
        ...
        print('Delivery man document does not exist.');
      }
    } catch (e) {
